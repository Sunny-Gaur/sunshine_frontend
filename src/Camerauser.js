...
export default function Camerauser() {
    ...
    function getdata() {
        axios.get(uri + "camera").then((succ) => {
            setdata2(succ.data);
        })
    }
            ...
            <div className=' '>
                ...
                <div className="col-md-12">
                    {data2.map((row) => (
                        ...
                        <div className='col-lg-2 col-md-3 col-sm-3 col-xs-6  box ' onClick={() => pro(row)} style={{ backgroundSize: 'cover', height: 280, paddingTop:0 }} key={row._id}>
