...
export default function Headphoneuser() {
    ...
    function getdata() {
        axios.get(uri + "headphone").then((succ) => {
            ...
            <div className=' container5 '>
                ...
                <div className="col-lg-12 col-md-12 col-xs-12">
                    ...
                    {data.map((row) => (
                        ...
                        <div className='col-lg-2 col-md-3 col-sm-3 col-xs-6  box' onClick={() => pro(row)} style={{ backgroundSize: 'cover', height: 275, paddingTop: 0 }} key={row._id}>
