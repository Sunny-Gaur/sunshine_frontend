            ...
            <div className='container container5 '>
                ...
                <div className="col-lg-12 col-md-12 col-xs-12">
                    ...
                    {data.map((row) => (
                        ...
                        <div className='col-lg-2 col-md-3 col-sm-3 col-xs-6  box m' onClick={() => pro(row)} style={{ backgroundSize: 'cover', height: 260, paddingTop: 0 }} key={row._id}>
